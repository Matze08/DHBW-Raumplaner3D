...
Das Backend wird über einen Node.js-Webserver gehostet. Das System wird cloudbasiert betrieben über DigitalOcean, da hier durch den Studentenstatus keine Kosten anfallen. Die Datenbank läuft parallel (MongoDB).
